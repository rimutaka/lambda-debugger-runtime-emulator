...
export LAMBDA_PROXY_REQ_QUEUE_URL=https://sqs.us-east-1.amazonaws.com/512295225992/LAMBDA_PROXY_REQ # Replace with your own queue URL (the a/c number will be different!)
export LAMBDA_PROXY_RESP_QUEUE_URL=https://sqs.us-east-1.amazonaws.com/512295225992/LAMBDA_PROXY_RESP # Replace with your own queue URL (the a/c number will be different!)
export LAMBDA_PROXY_TRACING_LEVEL=DEBUG
